...
public class RegionInfoController {
    ...
    public Result<List<CityInfo>> listCityInfoByProvinceId(@RequestParam Long id) {
        LambdaQueryWrapper<CityInfo> eq = new LambdaQueryWrapper<CityInfo>().eq(CityInfo::getProvinceId, id);
        List<CityInfo> list = cityInfoService.list(eq);
        return Result.ok(list);
    }
    ...
    public Result<List<DistrictInfo>> listDistrictInfoByCityId(@RequestParam Long id) {
        LambdaQueryWrapper<DistrictInfo> queryWrapper = new LambdaQueryWrapper<DistrictInfo>().eq(DistrictInfo::getCityId, id);
